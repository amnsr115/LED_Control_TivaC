 ...
 *********************************************************************************************************************/
#define SETBIT(PORT_REGISTER,PIN_NUMBER) 					(PORT_REGISTER|=(1U<<PIN_NUMBER)) 
#define CLEARBIT(PORT_REGISTER,PIN_NUMBER) 				(PORT_REGISTER&=~(1U<<PIN_NUMBER))
#define WRITEBIT (PORT_REGISTER,PIN_NUMBER,LEVEL)	(PORT_REGISTER|=(LEVEL<<PIN_NUMBER)
#define TOGGLEBIT(PORT_REGISTER,PIN_NUMBER) 			(PORT_REGISTER^=(1U<<PIN_NUMBER))
/**********************************************************************************************************************
